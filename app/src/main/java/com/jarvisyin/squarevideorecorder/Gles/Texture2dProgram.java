...
public class Texture2dProgram {
    private static final String TAG = ShaderUtils.TAG;
    ...
    public Texture2dProgram() {
        ...
        mProgramHandle = ShaderUtils.createProgram(
                ShaderUtils.loadFromAssetsFile("VideoRecordVertex.shader"),
                ShaderUtils.loadFromAssetsFile("VideoRecordFragment.shader"));
        ...
        ShaderUtils.checkLocation(maPositionLoc, "aPosition");
        maTextureCoordLoc = GLES20.glGetAttribLocation(mProgramHandle, "aTextureCoord");
        ShaderUtils.checkLocation(maTextureCoordLoc, "aTextureCoord");
        muMVPMatrixLoc = GLES20.glGetUniformLocation(mProgramHandle, "uMVPMatrix");
        ShaderUtils.checkLocation(muMVPMatrixLoc, "uMVPMatrix");
        muTexMatrixLoc = GLES20.glGetUniformLocation(mProgramHandle, "uTexMatrix");
        ShaderUtils.checkLocation(muTexMatrixLoc, "uTexMatrix");
        ...
        if (muKernelLoc < 0) {
            ...
            ShaderUtils.checkLocation(muTexOffsetLoc, "uTexOffset");
            muColorAdjustLoc = GLES20.glGetUniformLocation(mProgramHandle, "uColorAdjust");
            ShaderUtils.checkLocation(muColorAdjustLoc, "uColorAdjust");
    ...
    public int createTextureObject() {
        ...
        ShaderUtils.checkGlError("glBindTexture " + texId);
