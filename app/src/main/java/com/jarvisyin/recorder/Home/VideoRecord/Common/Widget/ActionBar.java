...
import com.jarvisyin.recorder.Common.Widget.ActionBar.TopView;
...
public class ActionBar extends LinearLayout {
    ...
    public ActionBar(Context context, AttributeSet attrs) {
        ...
        initValue(context);
        initWidget(context);
        analysisAttributes(context, attrs);
    }

    private void initValue(Context context) {
        setBackgroundResource(R.color.video_action_bar_bg);
        textColor0 = context.getResources().getColor(R.color.video_text_color);
    ...
    private void initWidget(Context context) {
        ...
        imgBack.setImageResource(R.drawable.common_button_back);
        imgBack.setOnClickListener(mBtnBackOnClickListener);
        setButtonStyle(context, imgBack, rParams);
        relativeLayout.addView(imgBack, rParams);
        ...
        line.setBackgroundResource(R.color.video_window_background);
        relativeLayout.addView(line, rParams);
    }

    private void analysisAttributes(Context context, AttributeSet attrs) {
