...
class TextureRender {
    private static final String TAG = "VShopVideo TextureRender";
    ...
    private ExplainRender explainRender;
    ...
    public void draw(SurfaceTexture st) {
        ...
        if (explainRender != null) explainRender.draw();
    ...
    public void setExplain(String explain) {
        ...
        if (explainRender == null) {
            explainRender = new ExplainRender();
        }
        explainRender.setExplain(explain);
    }
}